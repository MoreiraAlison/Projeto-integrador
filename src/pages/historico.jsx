  ...
  return (
    ...
    >
      <div className="historico-content">
        ...
        <p className="sub">Veja seus agendamentos anteriores.</p>
        ...
        <div className="cards">
          {agendamentosFiltrados.map(agendamento => (
            <div key={agendamento.id} className={`card ${agendamento.status}`}>
              <div className="card-header">
                <h3>{agendamento.profissional}</h3>
                <span className="status" style={{ backgroundColor: getStatusColor(agendamento.status) }}>
